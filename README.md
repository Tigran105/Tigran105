...
[cite_start]I am a **Front-End Developer** with over 5 years of experience specializing in **React** and **React Native**[cite: 1, 2, 11]. [cite_start]I’m passionate about building high-performance web and mobile applications, with a special focus on interactive **3D experiences** and user-centric solutions[cite: 11, 12, 13].

---

### 🛠 Tech Stack

- [cite_start]**Core:** JavaScript (ES6+), TypeScript, HTML5, CSS3[cite: 18].
- [cite_start]**Frameworks & Libraries:** React, Next.js, React Native, Three.js[cite: 19, 20, 21, 22, 25].
- [cite_start]**State Management:** Redux Toolkit, Zustand[cite: 31, 32, 33].
- [cite_start]**Styling:** Tailwind CSS, Sass (SCSS), Responsive & Mobile-First Design[cite: 26, 27, 28, 29, 30].
- [cite_start]**Graphics:** HTML Canvas, WebGL (basic)[cite: 36, 37].
- [cite_start]**Tools:** Git, GitHub, Vite, Figma[cite: 57, 58, 60, 61].
